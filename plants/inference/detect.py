...
##################################### 리펙토링 필요(필요없는 코드가 많아 보이는데 지웠다가 작동 안 될까봐 이후 추가 작업 진행)
"""
...
def parse_opt():
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=ROOT / '/workspace/yolov5/runs/train/pepper_yolov5s_results/weights/best.pt', help='model path or triton URL')  #################### 기본으로 들어가는 model 파일 지정
...
# print (str)
str = run(weights= '/backend/plants/inference/cucumber.pt', source = "https://silicon-valley-bootcamp.s3.ap-northeast-2.amazonaws.com/images/cucumber1.jpeg")
print (str)